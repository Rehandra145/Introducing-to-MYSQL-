...
CREATE TABLE TrTransaction(
    ...
    FOREIGN KEY(IDProduk) REFERENCES MsProduct(IDProduk),
...
CREATE TABLE TrReview(
    ...
    komen VARCHAR(100),
    Star INT NOT NULL,
    CONSTRAINT check1 CHECK(Star >= 1 AND Star <=5),
    FOREIGN KEY(IDProduk) REFERENCES MsProduct(IDProduk)
);
...
-- Delete input (typo njir)
DELETE FROM TrShop WHERE IDShop = 'SH145N';

-- 3. MsProduct
INSERT INTO MsProduct(IDShop, NamaProduk, Stok, Harga) VALUE
-- SHOP 1
...
-- 4. TrTransaction
INSERT INTO TrTransaction (IDTransaction, IDProduk, IDCustomer, TransactionDate, Qty, TotalHarga, Done, PaymentMethod) VALUES
...
-- 5. TrReviw
INSERT INTO TrReview(IDProduk, Komen, Star) VALUE
(1,'Good',5),
(1,'Nice',4),
(2,'I dont like it',2),
(2,'Best product',5),
...
-- 6. TrCart
INSERT INTO TrCart(IDProduk, IDCustomer) VALUES
-- CUSTOMER 1
(1,1),
(3,1),
(4,1),
